        ...
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                 ...
                 <h1 align="center" style="color:#66b3ff; font-family:cursive;">Footware World</h1>
                    <p1>We have the best & Wonderfull Footware....</p1>
                </div>
            </div>
            <h1 align="center"style="color:#808080; font-family:Sofia;font-size:52px">Running shoe's</h1>
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/shoes0.jpg" alt="campus Running Shoes">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Campus plaza blue<br/>Running Shoes</h3>
                                    <p>Price: Rs.899.00</p>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/shoes2.jpg" alt="Puma Running Shoes">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Puma Running<br/>Shoes</h3>
                                    <p>Price: Rs.3099.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/shoes3.jpg" alt="Nike Running Shoes">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Nike Men<br/>Skyelux Running <br/> Shoes</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/shoes4.jpeg" alt="Sparx Running Shoes">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Sparx SM-444 <br/>Gray Running Shoes</h3>
                ...
                <h1 align="center"style="color:#808080; font-family:Sofia;font-size:52px">Flip Flop's</h1>
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/flip1.jpg" alt="puma Flip Flop">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Puma Black Flip Flops</h3>
                                    <p>Price: Rs.449.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/flip2.jpg" alt="Sparx Flip Flop">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Sparx Sf2034G <br/>Maroon Flip Flops</h3>
                                    <p>Price: Rs.599.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/flip3.jpeg" alt="Adidas Flip Flop">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Adidas Eezay<br/>(black/grey) flip flop</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/flip4.jpg" alt="MAX Flip Flop">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>MAX Striped Flip Flop</h3>
                                    <p>Price: Rs.499.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                ...
                <h1 align="center"style="color:#808080; font-family:Sofia;font-size:52px">Sandal's</h1>
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/sandal1.jpg" alt="puma Sandal">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Puma Men<br/>Sandal</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/sandal2.jpg" alt="adidas sandal">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Adidas Sports Sandal</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/sandal3.jpg" alt="sparx sandal">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Sparx Navy Sandal</h3>
                                    <p>Price: Rs.750.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/sandal4.jpg" alt="Campus Sandal">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Campus Synthetic Sandal</h3>
                                    <p>Price: Rs. 670.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
