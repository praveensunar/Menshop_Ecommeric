        ...
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                 ...
                 <h1 align="center" style="color:#66b3ff; font-family:cursive;">Shirt's World</h1>
                    <p1>We have the best & Wonderfull Shirt's....</p1>
                </div>
            </div>
            <h1 align="center"style="color:#808080; font-family:Sofia;font-size:52px">Formal shirt's</h1>
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/formal1.jpg" alt="formalshirts">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Raymond blue formal shirt</h3>
                                    <p>Price: Rs.899.00</p>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/formalx.jpg" alt="formalshirts">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Heighlander white Formal Shirts</h3>
                                    <p>Price: Rs.599.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/formal3.jpeg" alt="formalshirts">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Celio Regular  Solids Formal Shirt</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/formal4.jpg" alt="formalshirts">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Allen Solly Black Formal Shirt</h3>
                                    <p>Price: Rs.1369.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
                ...
                <h1 align="center"style="color:#808080; font-family:Sofia;font-size:52px">Printed Shirt's</h1>
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/printed1.jpg" alt="Printed Shirt">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Gritstones-White  Men's printed Shirt</h3>
                                    <p>Price: Rs.699.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/printed2.jpg" alt="Printed Shirt">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Paul Street-Brown Men's printed Shirt</h3>
                                    <p>Price: Rs.599.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/printed3.jpg" alt="Printed Shirt">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Creations-Blue Men's printed Shirt</h3>
                                    <p>Price: Rs. 1099.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/printed4.jpg" alt="Printed Shirt">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>SCROTT- Fit Men's printed Shirt</h3>
                                    <p>Price: Rs.799.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                ...
                <h1 align="center"style="color:#808080; font-family:Sofia;font-size:52px">T-shirt's</h1>
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/tshirt1.jpg" alt="T-shirt">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>AUSTIN WOOD-Red Men's T-Shirt </h3>
                                    <p>Price: Rs.400.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/tshirt2.jpg" alt="T-shirt">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Puma-Polyester Grey Men's T-Shirt </h3>
                                    <p>Price: Rs.599.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/tshirt3.jpeg" alt="T-shirt">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Nike- Maroon Men's Polo T Shirt </h3>
                                    <p>Price: Rs.950.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/tshirt4.jpg" alt="T-shirt">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Aeropostale-Blue Men's Polo T Shirt</h3>
