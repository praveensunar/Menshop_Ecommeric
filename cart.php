                    ...
                    <tbody>
                       ...
                       <?php $counter=$counter+1;}?>
                        <tr>
                            ...
                            <th><a href="success.php?id=<?php echo $user_id?>" class="btn btn-primary">Confirm Order</a>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp<a class="btn btn-primary" href="index.php">HOME</a></th>
                        </tr>
                    </tbody>
                </table>
            </div>
